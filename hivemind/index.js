...
async function passEnvironment(environment){
    ...
    activeEnvPtr = module._initializeEnvironment(environment.gravity, environment.drag, environment.move_acc, environment.jump_speed);
...
window.addEventListener('focus', ()=>{focused = true; time_of_last_tick = performance.now();});
...
function tick(){
    ...
    module._doUpdate(delta_time, (player_in_right-player_in_left), player_in_up);
